...
public class c1_Introduction extends IntroductionBase {
     ...
     */
    @Test
    public void hello_world() throws ExecutionException, InterruptedException {
    ...
    public void unresponsive_service() {
        Exception exception = assertThrows(IllegalStateException.class, () -> {
            ...
            String result = serviceResult.block(Duration.ofSeconds(1L)); //todo: change this line only
        });
...
//        serviceResult.subscribe(results::add);
